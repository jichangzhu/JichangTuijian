...
### 快速导航
| 客户端                 | Windows |  <img width=5/>macOS<img width=5/>  |  <img width=11/>Linux<img width=11/>  |   <img width=15/>iOS<img width=15/>   | <img width=5/>Android<img width=5/> | <img width=5/>路由器<img width=5/> |
|---------------------|---------|-------|-------|-----|---------|-----|
| Clash for Android   |         |       |       |     | ✔       |     |
| Clash for Windows   | ✔       | ✔     | ✔     |     |         |     |
| Clash Verge         | ✔       | ✔     | ✔     |     |         |     |
